...
int main(int argc, const char *argv[])
{
    ...
    for (int stage2Method = 0; stage2Method < 3; ++stage2Method)
    {
        for (int i = 0; i < 3; ++i)
        {
            ...
            std::cout
                // << treename << " " << NPR << " " << CCR << " "
                << memory_constraint << " " << number_subtrees << " " << num_processors << " " << makespan << " " << stage2heuristic << " " << time << endl;
            ...
            if (number_subtrees > num_processors)
            {
                ...
                number_subtrees = HowmanySubtrees(treeobj, true);
                std::cout
                    //<< treename  << " NPR " << NPR << " CCR " << CCR
                    << " mem_constr " << memory_constraint << " #subtrees " << number_subtrees << " #proc " << num_processors << " " << makespan << " " << stage2heuristic << "+Merge " << time << endl;
            }
            else if (number_subtrees == num_processors)
            {
                std::cout
                    //<< treename  << " " << NPR << " " << CCR << " "
                    << memory_constraint << " " << number_subtrees << " " << num_processors << " " << makespan << " " << stage2heuristic << "+Nothing " << 0 << endl;
            }
            else
            {
                time = clock();
                ...
                std::cout
                    // << treename << " " << NPR << " " << CCR << " "
                    << memory_constraint << " " << number_subtrees << " " << num_processors << " " << makespan << " " << stage2heuristic << "+SplitAgain " << time << endl;
            }
